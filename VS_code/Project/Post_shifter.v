...
//Counters (for left shifting)=================================================
    ...
    always @(*) begin
        ...
        if (!Complement_Flag) begin //condition for right shift generally
            ...
            end else begin //output already normalized
    ...
    //Left shifting========================================================
            ...
            if(S_sum[27] == S_sum[26]) begin //too small [11 (small -ve), 00 (small +ve)]
